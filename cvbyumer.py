...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "⚜️ *𝐂𝐕 𝐁𝐘 𝐔𝐌𝐄𝐑*\n\n"
        "𝐋𝐞𝐭’𝐬 𝐜𝐫𝐞𝐚𝐭𝐞 𝐲𝐨𝐮𝐫 𝐩𝐫𝐨𝐟𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 𝐂𝐕.\n\n"
        "𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 *𝐅𝐮𝐥𝐥 𝐍𝐚𝐦𝐞*:",
        parse_mode="Markdown"
    )
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if step == "name":
        ...
        await update.message.reply_text("𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 *𝐏𝐡𝐨𝐧𝐞 𝐍𝐮𝐦𝐛𝐞𝐫*:")

    elif step == "phone":
        users[uid]["phone"] = text
        users[uid]["step"] = "email"
        await update.message.reply_text("𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 *𝐄𝐦𝐚𝐢𝐥 𝐀𝐝𝐝𝐫𝐞𝐬𝐬*:")

    elif step == "email":
        users[uid]["email"] = text
        users[uid]["step"] = "education"
        await update.message.reply_text("𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 *𝐄𝐝𝐮𝐜𝐚𝐭𝐢𝐨𝐧*:")

    elif step == "education":
        users[uid]["education"] = text
        users[uid]["step"] = "experience"
        await update.message.reply_text("𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 *𝐄𝐱𝐩𝐞𝐫𝐢𝐞𝐧𝐜𝐞*:")

    elif step == "experience":
        users[uid]["experience"] = text
        users[uid]["step"] = "skills"
        await update.message.reply_text(
            "𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 *𝐒𝐤𝐢𝐥𝐥𝐬* (comma separated):"
        )
        ...
        if text not in ("1", "2", "3"):
            await update.message.reply_text("𝐏𝐥𝐞𝐚𝐬𝐞 𝐬𝐞𝐧𝐝 1, 2, 𝐨𝐫 3")
            return

        users[uid]["template"] = text
        pdf_path = generate_cv(uid)
        await update.message.reply_document(open(pdf_path, "rb"))
        await update.message.reply_text("✅ 𝐘𝐨𝐮𝐫 𝐂𝐕 𝐢𝐬 𝐑𝐞𝐚𝐝𝐲")
        users.pop(uid, None)
